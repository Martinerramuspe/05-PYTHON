...
# COMPLEJIDAD 1-------------------------------------------------------------------------------------
usuarios_1 = {"juan":3,"martin":"Tecnico","agustin": 11.3} #definicion de set de valor
usuarios_1["martin"] # llamado de clave sin valor

# COMPLEJIDAD 2-------------------------------------------------------------------------------------
usuarios_2 = {"juan": {"edad":44, "rol": "ingenierio"}, #definicion de diccionario clave-valor
...
print(f"Como podes ver el diccionario toma el ultimo juan{usuarios} ")